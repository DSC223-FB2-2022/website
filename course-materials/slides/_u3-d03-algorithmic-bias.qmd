...
knitr::include_graphics("images/hathaway-effect-poster.jpg")
```
:::
...
knitr::include_graphics("images/google-translate-gender-bias.png")
```

## Amazon's experimental hiring algorithm {.smaller}
...
knitr::include_graphics("images/guardian-facial-recognition.png")
```
...
knitr::include_graphics("images/propublica-criminal-sentencing.png")
```
...
## {data-menu-title="Attorney General Quote"}
...
knitr::include_graphics("images/propublica-results.png")
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/propublica-machine-bias.png")
```
:::
...
## {data-menu-title="Ethics and Data Science"}
...
knitr::include_graphics("images/ethics-data-science.jpg")
```
:::
...
## {data-menu-title="Weapons of Math Destruction"}
...
```{r echo=FALSE, out.width="65%"}
knitr::include_graphics("images/weapons-of-math-destruction.jpg")
```
:::
...
## {data-menu-title="Algorithms of Oppression"}
...
```{r echo=FALSE, out.width="65%"}
knitr::include_graphics("images/algorithms-of-oppression.jpg")
```
:::
