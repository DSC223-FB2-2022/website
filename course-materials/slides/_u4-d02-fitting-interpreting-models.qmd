...
```{r height-width-plot_2, echo=FALSE, warning=FALSE}
...
## A closer look at model output {.bigger}
...
## A tidy look at model output {.bigger}
...
## Linear model with a single predictor {.smaller}    
...
## Categorical predictor with 3+ levels {.smaller}
...
## {data-menu-title="Height vs school" .smaller}
### Relationship between height and school 
