...
.question[
What can you say about the overall gender distribution? Hint: Calculate the following probabilities: $P(Admit given they are Male)$ and $P(Admit given they are Female)$.
]
...
- $P(Admit given they are Female)$ = 0.304
- $P(Admit given they are Male)$ = 0.445
