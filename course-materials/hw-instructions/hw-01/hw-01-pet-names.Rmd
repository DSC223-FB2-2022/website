...
The next few steps will walk you through the process of getting information of the repo to be cloned, cloning your repo in a new RStudio Server project, and getting started with the analysis.
...
Go to [RStudio](http://turing.cornellcollege.edu:8787/) and then **navigate to the course workspace** via the left sidebar.
It's very important that you do this for two reasons:


### Step 3. Clone the repo

In RStudio, click on **File** then choose **New Project**. Click **Version control** and then **Git**.

In the pop-up window, **paste the URL** you copied from GitHub, then click **OK**.You may be asked to input your password and PAT.
...
And by others, we mean your instructor or group.
...
This will prompt a dialogue box where you first need to enter your user name, and then your *PAT*.
This might feel cumbersome.But for this one assignment you'll have to manually enter each time you push in order to gain some experience with it.
