...
We make use of the SelectorGadget to identify the tags for the relevant nodes. Note that there is some guessing and checking with this. In this case, not only pay attention to what is shown in the box as the tag but also the tags shown when hovering over items. 
