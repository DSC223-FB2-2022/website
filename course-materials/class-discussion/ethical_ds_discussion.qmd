...
(c) The author argues that data scientists are not paid to assess the effects of their algorithms. Choose one of the questions below, quoted from the article. List some positive and negative effects that an algorithm might have on people's lives in that context. Cosider CARVE for each one as well.
